...
+ [[./textos/Teorema_de_Nicomaco.md][Teorema de Nicómaco]] (En [[./src/Teorema_de_Nicomaco.lean][Lean4]] y en [[./thy/Teorema de Nicomaco.thy][Isabelle]]).
+ [[./textos/Convergencia_del_producto.md][Si uₙ converge a a y vₙ a b, entonces uₙvₙ converge a ab]] (En [[./src/Convergencia_de_producto.lean][Lean4]]).
+ [[./textos/Limite_multiplicado_por_una_constante_2.md][Si el límite de la sucesión u(n) es a y c ∈ ℝ, entonces el límite de u(n)c es ac]] (En [[./src/Limite_multiplicado_por_una_constante_2.lean][Lean]]).
+ [[./textos/Limite_de_7u.md][Si el límite de u(n) es a, entonces el de 7u(n) es 7a]] (En [[./src/Limite_de_7u.lean][Lean4]]).
+ [[./textos/Principio_del_palomar.md][Principio_del_palomar]] (En [[./src/Principio_del_palomar.lean][Lean4]]).
...
+ [[./textos/Suma_de_potencias_de_dos.md][Pruebas de ∑k<n. 2^k = 2^n-1]] (En [[./src/Suma_de_potencias_de_dos.lean][Lean]] y en [[./thy/Suma_de_potencias_de_dos.thy][Isabelle]]).
+ [[./textos/Formula_de_Gauss_de_la_suma.md][Pruebas de "∑_{i<n} i = n(n-1)/2"]] (En [[./src/Formula_de_Gauss_de_la_suma.lean][Lean]] y en [[./thy/Formula_de_Gauss_de_la_suma.thy][Isabelle]]).
+ [[./textos/Prueba_de_(1+p)^n_mayor_o_igual_que_1+np.md][Pruebas de (1+p)^n mayor o igual que 1+np]] (En [[./src/Prueba_de_(1+p)^n_mayor_o_igual_que_1+np.lean][Lean]] y en [[./thy/Prueba_de_(1+p)^n_mayor_o_igual_que_1+np.thy][Isabelle]]).
+ [[./textos/Suma_de_los_primeros_cubos.md][Pruebas de 0³+1³+2³+3³+···+n³ = (n(n+1)/2)²]] (En [[./src/Suma_de_los_primeros_cubos.lean][Lean]] y en [[./thy/Suma_de_los_primeros_cubos.thy][Isabelle]]).
+ [[./textos/Suma_de_progresion_geometrica.md][Pruebas de a+aq+aq²+···+aqⁿ = a(1-qⁿ⁺¹)/(1-q)]] (En [[./src/Suma_de_progresion_geometrica.lean][Lean]] y en [[./thy/Suma_de_progresion_geometrica.thy][Isabelle]]).
+ [[./textos/Suma_de_progresion_aritmetica.md][Pruebas de a+(a+d)+(a+2d)+···+(a+nd)=(n+1)(2a+nd)/2]] (En [[./src/Suma_de_progresion_aritmetica.lean][Lean]] y en [[./thy/Suma_de_progresion_aritmetica.thy][Isabelle]]).
+ [[./textos/Suma_de_los_primeros_n_numeros_naturales.md][Pruebas de 0+1+2+3+···+n=n(n+1)/2]] (En [[./src/Suma_de_los_primeros_n_numeros_naturales.lean][Lean]] y en [[./thy/Suma_de_los_primeros_n_numeros_naturales.thy][Isabelle]]).
...
+ [[./textos/Los_limites_son_menores_o_iguales_que_las_cotas_superiores.md][Si x es límite de u e y es cota superior de u, entonces x ≤ y]] (En [[./src/Los_limites_son_menores_o_iguales_que_las_cotas_superiores.lean][Lean]] y en [[./thy/Los_limites_son_menores_o_iguales_que_las_cotas_superiores.thy][Isabelle]]).
+ [[./textos/CS_de_y_le_x.md][Si (∀ ε > 0, y ≤ x + ε), entonces y ≤ x]] (En [[./src/CS_de_y_le_x.lean][Lean]] y en [[./thy/CS_de_y_le_x.thy][Isabelle]]).
...
+ [[./textos/Fibonacci.md][Pruebas de equivalencia de definiciones de la función de Fibonacci]] (In [[./src/Fibonacci.lean][Lean4]] and [[./thy/Fibonacci.thy][Isabelle]]).
+ [[./textos/Razonamiento_sobre_arboles_binarios_Aplanamiento_e_imagen_especular.md][Pruebas de aplana (espejo a) = reverse (aplana a)]] (En [[./src/Razonamiento_sobre_arboles_binarios_Aplanamiento_e_imagen_especular.lean][Lean]] y en [[./thy/Razonamiento_sobre_arboles_binarios_Aplanamiento_e_imagen_especular.thy][Isabelle]]).
...
+ [[./textos/Pruebas_de_equivalencia_de_definiciones_de_inversa.md][Pruebas de equivalencia de definiciones de inversa]] (En [[./src/Pruebas_de_equivalencia_de_definiciones_de_inversa.lean][Lean]] e [[./thy/Pruebas_de_equivalencia_de_definiciones_de_inversa.thy][Isabelle]]).
+ [[./textos/Pruebas_de_take_n_xs_++_drop_n_xs_Eq_xs.md][Pruebas de take n xs ++ drop n xs = xs]] (In [[./src/Pruebas_de_take_n_xs_++_drop_n_xs_Ig_xs.lean][Lean]] and [[./thy/Pruebas_de_take_n_xs_++_drop_n_xs_Ig_xs.thy][Isabelle]]).
